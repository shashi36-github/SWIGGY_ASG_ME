...
@Component({
  ...
  styleUrls: ['./breakfast-restaurants.component.css'] // Corrected from 'styleUrl'
})
export class BreakfastRestaurantsComponent {
  restaurants: Restaurant[] = [
    ...
    },
    {
      ...
      imageUrl: "https://plus.unsplash.com/premium_photo-1672363353897-ae5a81a1ab57?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      type: "veg"
    },
    {
      id: 6,
      ...
      imageUrl: "https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      type: "non-veg"
    }
  ];
